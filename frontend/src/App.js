    ...
    <div>
      ...
      <div className="analysis-card" style={{ marginBottom: '24px' }}>
        <div style={{ display: 'flex', gap: '10px' }}>
          ...
          />
          <button className="btn" style={{ background: '#27272a', color: 'white' }} onClick={analyze} disabled={loading}>
    ...
    <div>
      ...
      <div className="analysis-card">
        <div style={{ display: 'flex', gap: '10px', marginBottom: '16px' }}>
          ...
          <button className="btn" style={{ background: '#27272a', color: 'white' }} onClick={hunt} disabled={loading}>
  ...
  return (
    <div>
      ...
      <div className="analysis-card" style={{ marginBottom: '24px' }}>
        ...
        <button className="btn" style={{ background: '#27272a', color: 'white' }} onClick={runML} disabled={loading}>
